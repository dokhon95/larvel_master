...
<head>
    ...
    <meta name="description" content="RIKKEISOFT">
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search on website...">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> User<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Add User</a>
                                </li>
